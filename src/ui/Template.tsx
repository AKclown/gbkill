...
const Template: React.FC<IList> = (props) => {
    ...
    if (!isRawModeSupported) {
        console.log(colors.red(`Oh no! GBkill does not support this terminal (TTY is required). This is a bug, which has to be fixed. Please try another command interpreter (for example, CMD in windows)`))
    }
